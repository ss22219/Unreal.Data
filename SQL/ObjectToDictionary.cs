...
namespace Unreal.Data.SQL
{
    ...
    public class ObjectUtility
    {
        ...
        public static Dictionary<string, object> ObjectToDictionary(object obj)
        {
            ...
            if (obj != null)
            {
                foreach (PropertyHelper property in GetObjectProperties(obj))
                {
        ...
        private static PropertyHelper[] GetObjectProperties(object instance)
        {
            ...
            if (!_reflectionCache.TryGetValue(type, out helpers))
            {
                ...
                {
                    PropertyHelper propertyHelper = new PropertyHelper(property);

                    newHelpers.Add(propertyHelper);
                }

                helpers = newHelpers.ToArray();
                _reflectionCache.TryAdd(type, helpers);
            }
